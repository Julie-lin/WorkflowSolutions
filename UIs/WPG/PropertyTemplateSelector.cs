...
namespace WPG
{
	public class PropertyTemplateSelector : DataTemplateSelector
	{
		...
		private DataTemplate FindDataTemplate(Property property, FrameworkElement element)
		{
            ...
            //if (!(property.PropertyType is String) && property.PropertyType is ThermoFileSelection)
            //    propertyType = typeof(ThermoFileSelection);
            //if (!(property.PropertyType is String) && property.PropertyType is ThermoFolderSelection)
            //    propertyType = typeof(ThermoFolderSelection);
